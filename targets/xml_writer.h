// $Id: xml_writer.h,v 1.14 2016/05/17 15:11:45 ist179042 Exp $ -*- c++ -*-
...
namespace zu {
  ...
  protected:
	std::string proccessBasicType(basic_type * const node){
			switch(node->name()){
