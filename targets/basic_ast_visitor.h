// $Id: basic_ast_visitor.h,v 1.13 2016/05/17 15:11:45 ist179042 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_variable_dec_node(zu::variable_dec_node * const node, int lvl) = 0;
  virtual void do_variable_def_node(zu::variable_def_node * const node, int lvl) = 0;
